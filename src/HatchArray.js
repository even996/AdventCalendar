...
/**
 * Visdomsord, morsomme quotes fra ulike nettsteder som
...
export const hatchArray = [
  {
    ...
    nr: 1,
    img: './img/1.jpg',
    text: '«I morgen er svært ofte den hektiske dagen i uka». – Ukjent',
    open: false,
  },
  {
    id: 'hatch-2',
  ...
  },
  {
    ...
    nr: 12,
    img: './img/12.jpg',
    text: 'Når alle tenker likt er det ingen som tenker. - Walter Lippman',
    open: false,
  },
  {
    id: 'hatch-13',
...
/**
 * Sender over (export) hatchArrayet med hatch elementer sortert random.
 */
